...
const Footer = () => {
  return (
    <footer
      className="bg-gray-800 text-white py-8 px-20"
      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-between space-y-8 md:space-y-0 md:space-x-8">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <p className="text-sm" style={{ color: "#cbcbcb" }}>
            ...
            <a
              ...
              className="text-gray-400 mt-2 hover:text-yellow-400"
              style={{}}
            >
              Contact Us
            </a>
        ...
        <div className="flex flex-col space-y-4">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li className="text-sm text-gray-400 cursor-pointer hover:text-yellow-400">
              Blog
            </li>
            <li className="text-sm text-gray-400 cursor-pointer hover:text-yellow-400">
              Contact
