...
const UserModal = ({ onClose }) => {
  ...
  return (
    <>
      ...
      <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center justify-center rounded-lg z-50 p-8 text-white" style={{backgroundColor: "#101010"}}>
        <h1 className="text-3xl font-bold mb-4">Book Hub Web App</h1>
        <div className="flex items-center justify-center p-4 mb-4" style={{backgroundColor: "#181818"}}>
          <div className="mr-4">
