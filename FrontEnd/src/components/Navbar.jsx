...
const Navbar = () => {
  ...
  return (
    <nav
      className="flex justify-between items-center px-20 py-4 fixed top-0 w-full transition-all duration-300"
      style={{
        backgroundColor: colorChange ? "#101010" : "transparent",
        zIndex: "999",
      }}
    >
      <div className="">
        <img
          className="h-[3.5rem] self-center"
      ...
      <div className="">
        <ul className="flex justify-between items-center text-sm">
          <Link to="/">
            <li className="mx-5 cursor-pointer text-gray-300 hover:text-yellow-400 transition duration-300">
              HOME
            </li>
          </Link>
